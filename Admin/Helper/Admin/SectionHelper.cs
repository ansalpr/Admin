...
{
    public class SectionHelper : BaseHelper
    {
        ...
        public bool CheckTheDataExistance(section entityObject)
        {
            bool result = false;
            ...
            try
            {
                ...
                sp_manageSection spParams = new sp_manageSection();
                spParams.secName = entityObject.SectionName;
                spParams.secCode = entityObject.SectionCode;
                spParams.secId = 0;
                spParams.action = "select";
                spParams.operation = "S";
                DO.BeginTRansaction();
                ds = DO.iteratePropertyObjectsSP(spParams, "sp_manageSection");
        ...
        public DataSet GetTheData(section entityObject)
        {
            DataSet ds = new DataSet();
            paramFile PF = new paramFile(ParamsPath);
            try
            {
                ...
                spParams.secName = entityObject.SectionName;
                spParams.secCode = entityObject.SectionCode;
                spParams.secId = entityObject.SectionId;
                spParams.action = "select";
                spParams.operation = "S";
                DO.BeginTRansaction();
                ds = DO.iteratePropertyObjectsSP(spParams, "sp_manageSection");
        ...
        public int UpdateTheData(section entityObject)
        {
            DataSet ds = new DataSet();
            paramFile PF = new paramFile(ParamsPath);
            try
        ...
        public int DeleteTheData(section entityObject)
        {
            DataSet ds = new DataSet();
            paramFile PF = new paramFile(ParamsPath);
            try
        ...
        public int ProcessInsertEntity(section entityObject)
        {
            int result = 0;
            string TableName = "section";
            string skipAttributes = "SectionId,CreatedDate,ModifiedDate,";
            paramFile PF = new paramFile(ParamsPath);
            try
            {
                string dbCon = PF.getDatabaseConnectionString(DBConstants.MainDB);
